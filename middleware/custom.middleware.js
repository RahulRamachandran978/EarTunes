...
async function catergoryMiddleware(req,res,next){
    try{
...
async function loggedInMiddeleware(req,res,next){
    try{
        if(req.session.user){
...
module.exports = {catergoryMiddleware,loggedInMiddeleware,cartProducts}